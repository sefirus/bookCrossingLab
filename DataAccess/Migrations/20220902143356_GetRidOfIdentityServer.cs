...
{
    public partial class GetRidOfIdentityServer : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullPath = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Pictures_Shelves_ShelfId",
                        column: x => x.ShelfId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentShelfId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_BookCopies_BookCopyId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_Shelves_ShelfId",
                        column: x => x.ShelfId,
                        principalTable: "Shelves",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCopies_CurrentShelfId",
                table: "BookCopies",
                column: "CurrentShelfId");

            migrationBuilder.CreateIndex(
                name: "IX_BookCopies_CurrentUserId",
                table: "BookCopies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pictures_ShelfId",
                table: "Pictures",
                column: "ShelfId");

            migrationBuilder.CreateIndex(
                name: "IX_Pictures_WriterId",
                table: "Pictures",
                column: "WriterId");
